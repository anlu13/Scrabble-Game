...
scrabble_Board.slots[0][0] = {letter_Multiplier: 1, word_Multiplier: 1, image: "images/Scrabble_Spaces/blank_space.png"};
scrabble_Board.slots[0][1] = {letter_Multiplier: 1, word_Multiplier: 1, image: "images/Scrabble_Spaces/blank_space.png"};
scrabble_Board.slots[0][2] = {letter_Multiplier: 1, word_Multiplier: 2, image: "images/Scrabble_Spaces/double_word_space.png"};
scrabble_Board.slots[0][3] = {letter_Multiplier: 1, word_Multiplier: 1, image: "images/Scrabble_Spaces/blank_space.png"};
scrabble_Board.slots[0][4] = {letter_Multiplier: 1, word_Multiplier: 1, image: "images/Scrabble_Spaces/blank_space.png"};
scrabble_Board.slots[0][5] = {letter_Multiplier: 1, word_Multiplier: 1, image: "images/Scrabble_Spaces/blank_space.png"};
scrabble_Board.slots[0][6] = {letter_Multiplier: 2, word_Multiplier: 1, image: "images/Scrabble_Spaces/double_letter_space.png"};
scrabble_Board.slots[0][7] = {letter_Multiplier: 1, word_Multiplier: 1, image: "images/Scrabble_Spaces/blank_space.png"};
scrabble_Board.slots[0][8] = {letter_Multiplier: 2, word_Multiplier: 1, image: "images/Scrabble_Spaces/double_letter_space.png"};
scrabble_Board.slots[0][9] = {letter_Multiplier: 1, word_Multiplier: 1, image: "images/Scrabble_Spaces/blank_space.png"};
scrabble_Board.slots[0][10] = {letter_Multiplier: 1, word_Multiplier: 1, image: "images/Scrabble_Spaces/blank_space.png"};
scrabble_Board.slots[0][11] = {letter_Multiplier: 1, word_Multiplier: 1, image: "images/Scrabble_Spaces/blank_space.png"};
scrabble_Board.slots[0][12] = {letter_Multiplier: 1, word_Multiplier: 2, image: "images/Scrabble_Spaces/double_word_space.png"};
scrabble_Board.slots[0][13] = {letter_Multiplier: 1, word_Multiplier: 1, image: "images/Scrabble_Spaces/blank_space.png"};
scrabble_Board.slots[0][14] = {letter_Multiplier: 1, word_Multiplier: 1, image: "images/Scrabble_Spaces/blank_space.png"};
...
scrabble_Board.print_Board = function () {
	...
	for (row = 0; row < scrabble_Board.rowCount; ++row) {
		for (col = 0; col < scrabble_Board.columnCount; ++col) {
			console.log("scrabble_Board.slots[" + row + "][" + col + "] letter: " + scrabble_Board.slots[row][col].letter + ", tileId: " + scrabble_Board.slots[row][col].tileId);
		}
	}
};
...
// Adds up the score. Removes all tiles from the board and adds to the rack whatever number of new tiles needed.
// finishes previous word, start the next word
function next_Word() {
...
function is_Dictionary_Word(word) {
	if (word.length > 0 && is_Dictionary_Word.dict[word]) {
		return true;
	}
	return false;
}
...
$.ajax({
	...
	success: function (result) {
		...
		for (var i = 0; i < words.length; ++i) {
			is_Dictionary_Word.dict[words[i].toUpperCase()] = true;
		}
	},
});
...
// opens up pop-up (dialog) box when blank tile for "pick-a-letter" tile is played selected letter replaces blank tile
function open_Blank_Tile_Dialog(blank_Tile_Draggable, tile_ID, input_row, input_col) {
	var tile_Selector_Dialog = $("<div id='blank_Tile_Dialog'></div>");
	...
	for (letter_Key in scrabble_Tiles) {
		if (letter_Key != "_") {
			...
			new_Tile.click(function () {
				...
				blank_Tile_Draggable.attr("letter", new_Letter);
				blank_Tile_Draggable.attr("src", scrabble_Tiles[new_Letter]["image"]);

				// update board
				tile_ID = blank_Tile_Draggable.attr("id");
				scrabble_Board.add_To_Slot(tile_ID, new_Letter, input_row, input_col);
